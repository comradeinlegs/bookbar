	...
	<div id="TitleArea">
		...
		<div id="TitleArea_Title">
			<div id="TitleArea_Title_Content">
				<img border="0" width="13" height="13" src="/bookBar/backStage/img/title_arrow.gif"/> 添加小食种类
			</div>
	    </div>
		<div id="TitleArea_End"></div>
	</div>
	<div id="MainArea">
		<form action="/bookBar/servlet/UploadFile?type=foodType&nextPath=/bookBar/backStage/menu/allFoodType.jsp" method="post" enctype="multipart/form-data">
			<div class="ItemBlock_Title">
        			<img width="4" height="7" border="0" src="/bookBar/backStage/img/item_point.gif">小食种类信息
        		</div>
