	...
	<div id="TitleArea">
		...
		<div id="TitleArea_Title">
			<div id="TitleArea_Title_Content">
				<img border="0" width="13" height="13" src="/bookBar/backStage/img/title_arrow.gif"/> 添加小食新品
			</div>
	    </div>
		<div id="TitleArea_End"></div>
	</div>
	<div id="MainArea">
		<form action="/bookBar/servlet/UploadFile?type=food&nowPath=/bookBar/backStage/menu/addFood.jsp&nextPath=/bookBar/backStage/menu/drinkList.jsp&nextPath=/bookBar/backStage/menu/foodList.jsp&tag=<%= request.getParameter("tag") %>" method="post" enctype="multipart/form-data">
