...
<body>
	...
	LinkedHashMap<String, String> info = DBExecute.extractInfo("name", name, "food").get(0);
	ArrayList<LinkedHashMap<String, String>> types = DBExecute.extractInfo("", "", "foodType");
	...
	<div id="TitleArea">
		...
		<div id="TitleArea_Title">
			<div id="TitleArea_Title_Content">
				<img border="0" width="13" height="13" src="/bookBar/backStage/img/title_arrow.gif"/> 更新小食新品
			</div>
	    </div>
		<div id="TitleArea_End"></div>
	</div>
	<div id="MainArea">
		<form action="/bookBar/servlet/UpdateFile?type=food&nowPath=/bookBar/backStage/menu/updateFood.jsp&nextPath=/bookBar/backStage/menu/drinkList.jsp&name=<%= info.get("name") %>&nextPath=/bookBar/backStage/menu/foodList.jsp" method="post" enctype="multipart/form-data">
			<div class="ItemBlock_Title">
        			<img width="4" height="7" border="0" src="/bookBar/backStage/img/item_point.gif">小食信息
        		</div>
					...
					<div class="ItemBlock2">
						<table cellpadding="0" cellspacing="0" class="mainForm">
							...
							<tr>
								...
								%>
								<td width="80px"><a href="<%= realPath %>">小食图片</a></td>
