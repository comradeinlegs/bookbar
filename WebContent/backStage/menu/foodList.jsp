...
<body>
	...
	<%
	int cnt = 1;
	ArrayList<LinkedHashMap<String, String>> infos = DBExecute.extractInfo("tag", request.getParameter("tag"), "food");
	...
	<div id="QueryArea">
		<form action="foodList.jsp?search=true&tag=<%= request.getParameter("tag") %>" method="post">
			<input type="text" name="keyword" title="请输入小食名称" value="<%= keyword %>">
	...
	<div id="MainArea">
	    <table class="MainArea_Content" align="center" cellspacing="0" cellpadding="0">
			...
			<tbody id="TableData">
				...
				<tr class="TableDetail1">
					...
					<td>
						<a href="updateFood.jsp?name=<%= info.get("name") %>"  class="FunctionButton">更新/查看信息</a>				
						<a href="/bookBar/backStage/DeleteFood?name=<%= info.get("name") %>&tag=<%= info.get("tag") %>" onClick="return delConfirm();"class="FunctionButton">删除</a>				
					</td>
				</tr>
				<%
				}
	    ...
	    <div id="TableTail" align="center">
			<div class="FunctionButton"><a href="addFood.jsp?tag=<%= request.getParameter("tag") %>">添加</a></div>
	    </div> 
	</div>
</body>
</html>