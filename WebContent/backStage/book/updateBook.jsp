...
<body>
	...
	ArrayList<LinkedHashMap<String, String>> types = DBExecute.extractInfo("", "", "bookType");
	...
	<div id="MainArea">
		<form action="/bookBar/servlet/UpdateFile?type=book&nowPath=/bookBar/backStage/book/updateBook.jsp&name=<%= info.get("name") %>&nextPath=/bookBar/backStage/book/bookList.jsp" method="post" enctype="multipart/form-data">
        		...
        		<div class="ItemBlockBorder">
					...
					<div class="ItemBlock2">
						<table cellpadding="0" cellspacing="0" class="mainForm">
							...
							<tr>
								<td>作者</td>
								<td><input type="text" name="author" class="InputStyle" value="<%= info.get("author") %>" disabled="true"/></td>
							</tr>
							<tr>
								<td>作者简介</td>
								<td><textarea name="authorIntro" class="TextareaStyle"><%= info.get("authorIntro") %></textarea></td>
							</tr>
							<tr>
								<td>作品简介</td>
								<td><textarea name="bookIntro" class="TextareaStyle"><%= info.get("bookIntro") %></textarea></td>
							</tr>
							<tr>
								<%
								...
								%>
								<td width="80px"><a href="<%= realPath %>">书籍图片</a></td>
