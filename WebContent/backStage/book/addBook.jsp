	...
	<div id="TitleArea">
		...
		<div id="TitleArea_Title">
			<div id="TitleArea_Title_Content">
				<img border="0" width="13" height="13" src="/bookBar/backStage/img/title_arrow.gif"/> 添加新书
			</div>
	    </div>
		<div id="TitleArea_End"></div>
	</div>
	<div id="MainArea">
		<form action="/bookBar/servlet/UploadFile?type=book&nowPath=/bookBar/backStage/book/addBook.jsp&nextPath=/bookBar/backStage/book/bookList.jsp&tag=<%= request.getParameter("tag") %>" method="post" enctype="multipart/form-data">
			<div class="ItemBlock_Title">
        			<img width="4" height="7" border="0" src="/bookBar/backStage/img/item_point.gif">新书信息
        		</div>
        		<div class="ItemBlockBorder">
					...
					<div class="ItemBlock2">
						<table cellpadding="0" cellspacing="0" class="mainForm">
							...
							<tr>
								<td>作者简介</td>
								<td><textarea name="authorIntro" class="TextareaStyle"></textarea></td>
							</tr>
							<tr>
								<td>作品简介</td>
								<td><textarea name="bookIntro" class="TextareaStyle"></textarea></td>
							</tr>
							<tr>
								<td width="80px">图片</td>
