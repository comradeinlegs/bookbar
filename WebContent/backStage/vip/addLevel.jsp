	...
	<div id="TitleArea">
		...
		<div id="TitleArea_Title">
			<div id="TitleArea_Title_Content">
				<img border="0" width="13" height="13" src="/bookBar/backStage/img/title_arrow.gif"/> 添加会员等级
			</div>
	    </div>
		<div id="TitleArea_End"></div>
	</div>
	<div id="MainArea">
		<form action="/bookBar/servlet/UploadFile?type=vipLevel&nextPath=/bookBar/backStage/vip/vipLevel.jsp" method="post" enctype="multipart/form-data">
        		...
        		<div class="ItemBlockBorder">
					...
					<div class="ItemBlock2">
						<table cellpadding="0" cellspacing="0" class="mainForm">
							...
							<tr>
								<td>价格</td>
								<td><input type="text" name="leastConsume" class="InputStyle"/></td>
							</tr>
						</table>
					</div>
	            </div>
