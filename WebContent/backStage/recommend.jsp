...
<body>
	...
	<%
	int cnt = 1;
	ArrayList<LinkedHashMap<String, String>> infos = DBExecute.extractInfo("", "", "recommend");
	...
	<div id="TitleArea">
		...
		<div id="TitleArea_Title">
			<div id="TitleArea_Title_Content">
				<img border="0" width="13" height="13" src="/bookBar/backStage/img/title_arrow.gif"/> 今日推荐
			</div>
    		</div>
	    ...
	    <table class="MainArea_Content" align="center" cellspacing="0" cellpadding="0">
			...
			<tbody id="TableData">
				...
				<tr class="TableDetail1">
					...
					<td>
						<a href="/bookBar/backStage/DeleteRecommend?name=<%= info.get("name") %>&type=<%= info.get("type") %>" onClick="return delConfirm();"class="FunctionButton">删除</a>				
					</td>
				</tr>
				<%
				}
